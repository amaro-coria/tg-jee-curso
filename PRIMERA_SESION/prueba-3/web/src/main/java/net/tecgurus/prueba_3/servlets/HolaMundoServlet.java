...
import net.tecgurus.servicios.PruebaExterna;
...
public class HolaMundoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.getWriter().append("Mensaje desde el EJB: ").append(instanciaInyectada.saludar() + " - OTRO SALUDO - "+instancia2.saluda2() + "OTRO MAS: "+externo.otroMas());
	}
